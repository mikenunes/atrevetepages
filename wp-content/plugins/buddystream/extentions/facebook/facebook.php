...
class BuddystreamFacebook
{
    ...
    protected $_userName;
     ...
     {
         return "https://graph.facebook.com/oauth/authorize?client_id=".$this->getApplicationId()."&redirect_uri=".$this->getCallbackUrl()."&scope=offline_access,publish_stream,friends_status,read_stream";
     }
        ...
        if($wall->data){
            foreach($wall->data as $item) {
                ...
                $item = (array) $item;
                       ...
                       if($this->getApplicationId() == $item["application"]->id){
                           $filter2 = 0;
                       }
