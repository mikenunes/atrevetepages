	...
	<form action="" method="post" name="createuser" id="createuser" class="add:users: validate">
		...
		<table class="form-table">
			...
			<tr>
				...
				<td><?php echo CAA_Config::skype_url_prefix; ?><input name="skype" type="text" id="skype" value="" />?userinfo</td>
			</tr>
			<tr>
				<th scope="row"><label for="xing">Xing</label></th>
				<td><?php echo CAA_Config::xing_url_prefix; ?><input name="xing" type="text" id="xing" value="" /></td>
			</tr>
			<tr>
				<th scope="row"><label for="custom_1">Custom 1</label></th>
				<td>Icon url:<input name="custom_icon_1" type="text" id="custom_icon_1" value="" /> Link url:<input name="custom_link_1" type="text" id="custom_link_1" value="" /></td>
			</tr>
			<tr>
				<th scope="row"><label for="custom_2">Custom 2</label></th>
				<td>Icon url:<input name="custom_icon_2" type="text" id="custom_icon_2" value="" /> Link url:<input name="custom_link_2" type="text" id="custom_link_2" value="" /></td>
			</tr>
			<tr>
				<th scope="row"><label for="custom_3">Custom 3</label></th>
				<td>Icon url:<input name="custom_icon_3" type="text" id="custom_icon_3" value="" /> Link url:<input name="custom_link_3" type="text" id="custom_link_3" value="" /></td>
			</tr>
			<tr>
