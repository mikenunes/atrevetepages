...
=1.5.5=
* Fix problem with adding Custom About Author for some websites.
* June 9th 2013

=1.5.4=
* Added rel="me author publisher" to Google+ link so that Google with link your profile with your post and your Google+ photo will show up next to your posts in the search engine.
* Refer to http://support.google.com/webmasters/bin/answer.py?hl=en&answer=1408986 for more information about adding Author information to search results.
* Apr 21th 2013

=1.5.3=
* Changed the way css is enqueue as suggested by users Jon Brown and Baden. Thanks Guys!
* Mar 13th 2013

=1.5.2=
* Fix issue with add custom about authors for some users in version 1.5 or 1.5.1
* Mar 13th 2013

=1.5.1=
* Fix issue with custom icon 1 being printed outside of the custom author box
* Feb 19th 2013

= 1.5 =
* Added new social media fields (Skype, Xing)
