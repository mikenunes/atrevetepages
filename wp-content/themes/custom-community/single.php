		...
		<div class="padder">
			...
			<div class="page" id="blog-single">
				...
				<?php if (have_posts()) : while (have_posts()) : the_post(); ?>
					...
					<div id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
						...
						<div class="post-content span11" style="<?php if($cc_post_options['cc_post_template_avatar'] == '1') { echo 'margin-left:0;'; } ?>">	
							...
							<div class="entry">
								...
								<?php } ?>
								<?php the_content( __( 'Leia mais &rarr;', 'cc' ) ); ?>
							...
							<?php if($cc_post_options['cc_post_template_comments_info'] != '1') {?>
								<p class="postmetadata"><span class="comments"><?php comments_popup_link( __( 'Sem comentários &#187;', 'cc' ), __( '1 Commentário &#187;', 'cc' ), __( '% Comentários &#187;', 'cc' ) ); ?></span></p>
							<?php } ?>
					...
					<?php endwhile; else: ?>
						<p><?php _e( 'Não encontrámos nenhum artigo que corresponda à sua pesquisa.', 'cc' ) ?></p>
					<?php endif; ?>
			</div>
