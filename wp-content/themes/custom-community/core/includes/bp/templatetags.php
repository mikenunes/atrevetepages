...
function bp_dtheme_comment_form( $default_labels ) {
	...
	$new_labels = array(
		...
		'logged_in_as'   => '',
		'must_log_in'    => '<p class="alert">' . sprintf( __( 'Tem que estar <a href="%1$s">ligado</a> para comentar.', 'cc' ), wp_login_url( get_permalink() ) )	. '</p>',
		'title_reply'    => __( 'Deixe um comentário!', 'cc' )
	);
