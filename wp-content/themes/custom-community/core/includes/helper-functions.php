...
function cc_switch_css(){
	...
	$switch_css =  array(
						...
						'container_alt_bg_color' => 'e36039',
						'details_bg_color'       => 'e36039', 
		...
		switch ($cap->style_css){
	        ...
	        case __('white','cc'):
				$switch_css =  array(
									'body_bg_color'          => 'ffffff',
									'container_bg_color'     => 'ffffff',
									'container_alt_bg_color' => 'c7e6db',
									'details_bg_color'       => '467d75', 
									'details_hover_bg_color' => 'f9f9f9',
									'font_color'             => '888888',
									'font_alt_color'         => 'afafaf',
									'link_color'             => '489ed5',
